...
11. 챔피언 컬럼의 값을 0또는 1로 치환해준 후 모두 하나로 붙여준뒤에 (011010110101 이런식으로 나오게됨) 
    standard scaler 로 데이터를 표준화 시켜줌


12. 7개의 클러스터로 나눈 결과 4개의 클러스터링은 제대로 되었다
    다만 0번 클러스터의 결과는 여러덱의 혼합물이었으므로 특별히 분석해야함
